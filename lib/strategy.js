...
function Strategy(options, verify) {
  ...
  options.tokenURL = options.tokenURL || 'https://api.nuapi.co/oauth/authorization/token';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'nuwe';
  this._userProfileURL = options.userProfileURL || 'https://api.nuapi.co/oauth/authorization.json';
}
